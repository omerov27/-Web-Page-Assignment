...
<body>
  <div id="container">
    ...
    <div id="kulup-fb-admin">
      ...
      <a href="yonetimekle.php"><button class="bn632-hover bn26"style="margin-left: 40px;"><i class="bi bi-person-plus " width="35px" height="35px"></i></button></a>
      <?php
       ...
       echo '
          <div class="card" style="width: 18rem; ">
           ...
           <div class="card-body">
              ...
              <a href=yonetimsil.php?id=' . $id . '><i class="bi bi-trash"></i><a/>
            </div>
          </div> 
       ';
       }
      ...
      <a href="yonetimekle2.php"><button class="bn632-hover bn26" style="margin-left: 50px;"><i class="bi bi-person-plus " width="35px" height="35px"></i></button></a>
      <?php
       ...
       while ($satir = mysqli_fetch_array($sonuc)) {
        ...
        <div class="card" style="width: 18rem;  margin-bottom:25px;">
         ...
         <div class="card-body">
           ...
           <h5 class="card-text">' . $mevki . '</h5>
           <a href=yonetimsil2.php?id=' . $id . '><i class="bi bi-trash"></i><a/>
          </div>
        </div> <br><br>';
       }
