  ...
  <div id="header">
   ...
   <div>
    <div id="kulup-fb-admin">
       ...
       <h1 style="padding-top: 20px; padding-left:35px"> Oyuncu Kadromuz</h1>
        <a href="ekle.php"><button class="bn632-hover bn26"style="margin-left: 40px;"><i class="bi bi-person-plus " width="35px" height="35px"></i></button></a>
            ...
            echo'
             <div class="card" style="width: 18rem; margin-bottom:5px;">
               ...
               <div class="card-body">
                 ...
                 <h6 class="card-text">'.$yas.'</h6>
                 <h6 class="card-text">'.$mevki.'</h6><br>
